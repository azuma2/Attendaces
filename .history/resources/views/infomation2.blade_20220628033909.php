...
<form action="/serch" method="GET">
  @csrf
  <input type="hidden" name="input" value="{{ \Carbon\Carbon::today()->subDays(2)->format("Y-m-d") }}" >
  <input type="submit" value="testu">
</form>

<input type="button" value="←前の週" id="back_day">
<input size="8" id="hiduke">
<input type="button" value="次の週→" id="next_day">
...
<form action="/serch" method="GET">
              <input type="text" name="input" value="2022-06-25">
  ...
  <input type="button" value="←前の週" id="back_btn">
<input size="8" id="date_txt">
<input type="button" value="次の週→" id="next_btn">
...
document.getElementById("back_day").onclick = function(){
    //カウンタをカウントダウンする
    cnt--;

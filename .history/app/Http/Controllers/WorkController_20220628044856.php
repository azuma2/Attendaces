...
class WorkController extends Controller
{
    ...
    {
        // $carbon = Carbon::now();
        //$carbons = Carbon::parse('2022-06-28');
        //$carbons->subDays(3)->format("Y-m-d");
        ...
        //$carbon->decrement('dat', 1)->format("Y-m-d");
$today = Carbon::now();
echo $today; // 2016-06-16 09:52:03

$dt = Carbon::create(2022, 06, 28, 10, 20, 30);
echo $dt; // 2000-12-12 10:20:30
    ...
    $rests = Rest::where('restIn', 'LIKE',"%{$request->input2}%")->get();
        ...
        $users = Auth::user();
        $rests = Rest::all();
        $items = Timestamp::where('punchIn', $request->$carbons)->get();
        return view('/infomation2', compact('rests','items','users','carbons'));
    }
